...
struct Artist : Codable{
    ...
    static func loadArtists() -> [Artist] {
        return [
            ...
            Artist(name: "Craig David", stage: .MainNorth, dayOfPerformance: .Vrijdag, startDateTimeOfPerformance: DateHelper.createDate(day: 7, month: 9, year: 2019, hour: 01, minutes: 25), endDateTimeOfPerformance: DateHelper.createDate(day: 7, month: 9, year: 2019, hour: 02, minutes: 25)),
